...
<div id="createModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 w-full h-full">
    <div class="flex items-center justify-center w-full h-full">
        <div class="bg-slate-200 p-7 rounded shadow-lg max-w-4xl w-full relative max-h-screen overflow-y-auto">
            ...
            <div class="main-title flex flex-col items-center gap-3 mb-8">
                <div class="title text-2xl font-semibold text-[#2e5382]">Nuevo</div>
                <div class="blue-line w-2/5 h-0.5 bg-[#64d423]"></div>
            </div>
            <!-- Contenido del modal -->
            <form id="form" action="{{ route('direcciones.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-6">
                @method('POST')
                @csrf
                ...
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="text" id="descripcion" name="descripcion" value="" class="w-full px-4 py-2 border rounded" rows=6 required></textarea>
                        </div>
                    </div>
                    <!-- Columna derecha -->
                    <div class="w-full md:w-1/2">
