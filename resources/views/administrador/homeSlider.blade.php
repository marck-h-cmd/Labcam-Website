    ...
    <div class="grid grid-cols-2 gap-8 items-center justify-center py-7">
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="relative">
                ...
                <img id="image1-preview" src="{{ asset('/user/template/images/carrusel/carrusel_01.png') }}" alt="Foto 1"
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="relative">
                <img id="image2-preview" src="{{ asset('/user/template/images/carrusel/carrusel_02.jpg') }}" alt="Foto 2"
                    class="w-[500px] h-80 object-cover rounded-md" />
        ...
        <div class="col-span-2 flex justify-center pt-2">
            <div class="flex flex-col items-center">
                ...
                <div class="relative">
                    <img id="image3-preview" src="{{ asset('/user/template/images/carrusel/carrusel_03.jpg') }}"
