...
@section('contenido')
                                ...
                                @if ($noticia->imagen)
                                    <div class="px-8 py-0.1 text-center">
                                        <button
                                            ...
                                            onclick='openModal(@json(Storage::url($noticia->imagen)), "image")'>
    ...
    <script>
        ...
        function openEditModal(button) {
            // Se espera que el botón tenga data-noticia con el JSON de la noticia
            ...
            document.getElementById('edit_contenido').value = noticia.contenido;
            document.getElementById('edit_autor').value = noticia.autor;
            document.getElementById('edit_fecha').value = noticia.fecha;

            // Configura la acción del formulario (por ejemplo, /notici/{id})
