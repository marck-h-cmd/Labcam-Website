                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 flex space-x-4">
                               ...
                               <!-- Formulario de Eliminar -->
                                <button onclick="openDeleteModal({{ $noticia->id }}, '{{ $noticia->titulo }}')" class="text-red-500 hover:text-red-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="bg-white p-7 rounded shadow-lg max-w-7xl w-full relative">
            ...
            <form action="{{ route('noticias.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="fecha" name="fecha" class="w-full px-4 py-2 border rounded" required>
                </div>
                <div class="mb-4">
                    <label for="imagen" class="block">Imagen</label>
                    <input type="file" id="imagen" name="imagen" class="w-full px-4 py-2 border rounded" required>
                </div>
