...
@section('title', 'Modificar Areas de Investigación')
                    ...
                    <div class="max-w-[1200px] mx-auto sm:px-6 lg:px-8 space-y-6">
                        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            <div class="w-full">
                                ...
                                <form class="sm:flex sm:items-center" action="{{ route('areas.update', $area->id) }}" method="post"
                                    id="form">
                                    @csrf
                                    @method('PUT')
                                    <div class="sm:flex-auto">
                                        ...
                                        <label for="nombre"
                                            class="block mb-2 text-sm font-medium text-gray-900 align-baseline">Nombre Area de Investigación</label>
                                        <input type="text" value="{{$area->nombre}}" name="nombre" id="nombre"
                                    ...
                                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none space-y-4">
                                        ...
                                        <a type="button" href="{{route('areas-panel')}}"
