        ...
        <div class="mb-4 border-b-2 border-gray-200  ">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab"
                ...
                <li class="me-2" role="presentation">
                    <a href="{{route('areas-panel')}}" class="inline-block p-4 rounded-t-lg border-b-2 border-[#64d423] cursor-pointer"
                    ...
                    <div class="max-w-[1200px] mx-auto sm:px-6 lg:px-8 space-y-6">
                        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            <div class="w-full">
                                ...
                                <form class="sm:flex sm:items-center" action="{{ route('areas.store') }}" method="post"
                                    id="form">
                                    @csrf
