        ...
        <div class="sm:flex sm:justify-center sm:items-start flex-col sm:flex-row gap-4">
            ...
            <div class="bg-gray-200 p-6 w-60 m-10 shadow-md rounded sm:sticky top-5"> {{-- //NO TOCAR!! --}}
                <ul id="categoryList" class="space-y-2">
                    <li>
                        <button onclick="showSection('investigadores', this)" id="defaultBtn" class="bloque block w-full text-left px-4 py-2 bg-blue-600 text-white rounded">Química</button>
                    </li>
                    ...
                    <div id="extraCategories" class="hidden">
                        ...
                        <li><button onclick="showSection('opcionExtra5', this)" class="bloque block w-full text-left px-4 py-2 hover:bg-gray-300 rounded">Nano</button></li>
                        <li><button onclick="showSection('opcionExtra6', this)" class="bloque block w-full text-left px-4 py-2 hover:bg-gray-300 rounded">Nano</button></li>
                        <li><button onclick="showSection('opcionExtra7', this)" class="bloque block w-full text-left px-4 py-2 hover:bg-gray-300 rounded">Nano</button></li>
                        <li><button onclick="showSection('opcionExtra8', this)" class="bloque block w-full text-left px-4 py-2 hover:bg-gray-300 rounded">Nano</button></li>
                    </div>
                    <li id="loadMoreBtn">
                        <button onclick="loadMoreCategories()" class="block w-full text-left px-4 py-2 hover:bg-gray-300 rounded">
                             <img width="30" height="30" src="https://img.icons8.com/stickers/50/expand-arrow.png" alt="expand-arrow"/>
                        </button>
                    </li>
                </ul>                
            </div>
