                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-lg">
                        ...
                        <div class="relative w-full bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl group overflow-hidden">
                            <div class="w-full h-full block">
                                ...
                                <p class="text-lg text-black truncate block capitalize mt-3 select-none">
                                    Grado Académico: {{ $investigador->carrera}}
                                </p>
                        ...
                        <div class="absolute inset-0 bg-[#1E5397] bg-opacity-35 flex items-center justify-center opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-in-out rounded-xl backdrop-blur-md">
                            <div class="flex flex-col gap-4">
                                <a href="/user/template/uploads/pdfs/{{ $investigador->cv }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    Ver CV
                                </a>
                                <a href="/user/template/uploads/pdfs/{{ $investigador->linkedin }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    Linkedin
                                </a>
                                <a href="/user/template/uploads/pdfs/{{ $investigador->ctiVitae }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    CTI Vitae
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-lg">
                        ...
                        <div class="relative w-full bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl group overflow-hidden">
                            <div class="w-full h-full block">
                                ...
                                <p class="text-lg text-black truncate block capitalize mt-3 select-none">
                                    Grado Académico: {{ $egresado->carrera}}
                                </p>
                                <p class="text-base font-normal text-black cursor-auto my-3 break-words select-none">
                                    Área de Investigación: {{$egresado->areaInvestigacion->nombre}}
                                </p>
                                <p class="text-base text-black truncate block capitalize mt-3 select-none">
                            ...
                            <!-- Texto de hover con animación desde abajo y fondo difuminado -->
                        <div class="flex flex-col gap-4">
                            <a href="/user/template/uploads/pdfs/{{ $egresado->cv }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                Ver CV
                            </a>
                            <a href="/user/template/uploads/pdfs/{{ $egresado->linkedin }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                Linkedin
                            </a>
                            <a href="/user/template/uploads/pdfs/{{ $egresado->ctiVitae }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                CTI Vitae
                            </a>
                        </div>
                        @endforeach
                ...
                <div id="tesistas" class="dynamic-section hidden">
                    ...
                    <div id="pregrado" class="tesistas-content hidden">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-lg">
                            ...
                            <div class="relative w-full bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl group overflow-hidden">
                                <div href="#" class="w-full h-full block">
                                    ...
                                    <p class="text-lg text-black truncate block capitalize mt-3 select-none">
                                        Grado Académico: {{ $tesista_pre->carrera}}
                                    </p>
                                    <p class="text-base font-normal text-black cursor-auto my-3 break-words select-none">
                                        Área de Investigación: {{$tesista_pre->areaInvestigacion->nombre}}
                                    </p>
                                    <p class="text-base text-black truncate block capitalize mt-3 select-none">
                            ...
                            <div class="absolute inset-0 bg-[#1E5397] bg-opacity-35 flex items-center justify-center opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-in-out rounded-xl backdrop-blur-md">
                                <div class="flex flex-col gap-4">
                                    <a href="/user/template/uploads/pdfs/{{ $tesista_pre->cv }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                        Ver CV
                                    </a>
                                    <a href="/user/template/uploads/pdfs/{{ $tesista_pre->linkedin }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                        Linkedin
                                    </a>
                                    <a href="/user/template/uploads/pdfs/{{ $tesista_pre->ctiVitae }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                        CTI Vitae
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-lg">
                            ...
                            <div class="relative w-full bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl group overflow-hidden">
                                <div href="#" class="w-full h-full block">
                                    ...
                                    <p class="text-lg text-black truncate block capitalize mt-3 select-none">
                                        Grado Académico: {{ $tesista_pos->carrera}}
                                    </p>
                                    <p class="text-base font-normal text-black cursor-auto my-3 break-words select-none">
                                        Área de Investigación: {{$tesista_pos->areaInvestigacion->nombre}}
                                    </p>
                                    <p class="text-base text-black truncate block capitalize mt-3 select-none">
                            ...
                            <div class="absolute inset-0 bg-[#1E5397] bg-opacity-35 flex items-center justify-center opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-in-out rounded-xl backdrop-blur-md">
                                <div class="flex flex-col gap-4">
                                    <a href="/user/template/uploads/pdfs/{{ $tesista_pos->cv }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                        Ver CV
                                    </a>
                                    <a href="/user/template/uploads/pdfs/{{ $tesista_pos->linkedin }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                        Linkedin
                                    </a>
                                    <a href="/user/template/uploads/pdfs/{{ $tesista_pos->ctiVitae }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                        CTI Vitae
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-lg">
                        ...
                        <div class="relative w-full bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl group overflow-hidden">
                            <div href="#" class="w-full h-full block">
                                ...
                                <p class="text-lg text-black truncate block capitalize mt-3 select-none">
                                    Grado Académico: {{ $pasante->carrera}}
                                </p>
                                <p class="text-base font-normal text-black cursor-auto my-3 break-words select-none">
                                    Área de Investigación: {{$pasante->areaInvestigacion->nombre}}
                                </p>
                                <p class="text-base text-black truncate block capitalize mt-3 select-none">
                        ...
                        <div class="absolute inset-0 bg-[#1E5397] bg-opacity-35 flex items-center justify-center opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-in-out rounded-xl backdrop-blur-md">
                            <div class="flex flex-col gap-4">
                                <a href="/user/template/uploads/pdfs/{{ $pasante->cv }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    Ver CV
                                </a>
                                <a href="/user/template/uploads/pdfs/{{ $pasante->linkedin }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    Linkedin
                                </a>
                                <a href="/user/template/uploads/pdfs/{{ $pasante->ctiVitae }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    CTI Vitae
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-lg">
                        ...
                        <div class="relative w-full bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl group overflow-hidden">
                            <div class="w-full h-full block">
                                ...
                                <p class="text-lg text-black truncate block capitalize mt-3 select-none">
                                    Grado Académico: {{ $aliado->carrera}}
                                </p>
                                <p class="text-base font-normal text-black cursor-auto my-3 break-words select-none">
                                    Área de Investigación: 
                        ...
                        <div class="absolute inset-0 bg-[#1E5397] bg-opacity-35 flex items-center justify-center opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-in-out rounded-xl backdrop-blur-md">
                            <div class="flex flex-col gap-4">
                                <a href="/user/template/uploads/pdfs/{{ $aliado->cv }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    Ver CV
                                </a>
                                <a href="/user/template/uploads/pdfs/{{ $aliado->linkedin }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    Linkedin
                                </a>
                                <a href="/user/template/uploads/pdfs/{{ $aliado->ctiVitae }}" class="text-white text-base font-semibold select-none bg-[#98C560] hover:bg-[#a6d073] px-3 py-2 rounded-lg cursor-pointer text-center">
                                    CTI Vitae
                                </a>
                            </div>
                        </div>
