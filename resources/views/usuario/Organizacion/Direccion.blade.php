            ...
            <div id="contenido-dinamico" class="flex-1 p-4 w-full">
                ...
                <div id="general" class="flex flex-col items-center gap-10">
                    ...
                    <div class="text-center bg-white shadow-xl rounded-lg p-4 w-full max-w-[17rem] aspect-square flex flex-col justify-center items-center">
                        <img class="w-32 h-32 md:w-40 md:h-40 object-cover rounded-full border-2 border-gray-300" src="/user/template/images/{{$jefe->foto}}" alt="{{$jefe->foto}}">
                ...
                <div id="jefe" class="hidden">
                    <div class="text-center ">
                        <img src="/user/template/images/{{$jefe->foto}}" alt="Profile" class="mx-auto mb-4 w-40 h-40 md:w-48 md:h-48 object-cover rounded-full border-2 border-gray-300">
