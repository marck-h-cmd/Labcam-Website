    ...
    @if (session('success'))
                    <div class="mb-8 p-6 bg-white border border-green-400 font-bold text-black-900 rounded-lg text-center shadow-md">
                        ...
                        <div class="mt-7 flex justify-center" >
                            <a href="{{ route('login') }}" class="bg-green-500 text-white px-5 py-2 rounded-lg text-lg font-semibold hover:bg-green-600 transition duration-300 flex items-center justify-center">
                                Iniciar sesión
                            </a>
                        </div>
                    </div>
