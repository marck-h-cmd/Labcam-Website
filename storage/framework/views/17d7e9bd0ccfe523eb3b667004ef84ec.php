...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/about.css', 'resources/js/app.js']); ?>
            ...
            <div class="vd wo/4 sd qo f ho oo wf yf ml-44"
                ...
                <nav>
                    <ul class="tc _o sf yo cg ep">
                        <li><a href="<?php echo e(route('home')); ?>" class="xl text-white"
                        ...
                        <li class="c i" x-data="{ dropdown: false }">
                            ...
                            <ul class="a" :class="{ 'tc': dropdown }">
                                <li><a href="<?php echo e(route('about')); ?>" class="xl"
                                        :class="{ 'mk': page === 'blog-grid' }">Acerca</a></li>
                                <li><a href="<?php echo e(route('historia')); ?>" class="xl"
                                        :class="{ 'mk': page === 'blog-single' }">Historia</a></li>
                                <li><a href="<?php echo e(route('biblioteca')); ?>" class="xl"
                        ...
                        <li class="c i" x-data="{ dropdown: false }">
                            ...
                            <!-- Dropdown Start -->
                            <ul class="a" :class="{ 'tc': dropdown }">
                                <li><a href="<?php echo e(route('direccion')); ?>" class="xl"
                                        :class="{ 'mk': page === 'blog-grid' }">Dirección</a></li>
                                <li><a href="<?php echo e(route('capital')); ?>" class="xl"
...
<?php /**PATH D:\CURSOS EXTRAS\PAGINA LABCAM\PROYECTO COMPARTIDO\Labcam-Website\resources\views/usuario/layout/plantilla.blade.php ENDPATH**/ ?>