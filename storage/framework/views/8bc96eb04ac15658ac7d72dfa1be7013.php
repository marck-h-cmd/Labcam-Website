                ...
                <ul
                    ...
                    <li>
                        <a href="<?php echo e(route('home')); ?>"
                            class="text-white block py-2 px-3 rounded md:border-0 md:hover:text-[#98C560] hover:bg-[#98C560] md:hover:bg-transparent md:p-0 <?php echo e(request()->routeIs('home') ? 'text-white bg-[#98C560] md:bg-transparent md:text-[#98C560]' : 'text-white bg-transparent'); ?>">
                            Inicio
                        </a>
                    </li>
                    ...
                    <li class="relative">
                        <button id="dropdownNavbarLink"
                            class="flex items-center justify-between w-full py-2 px-3 text-white hover:bg-[#98C560] rounded-md md:hover:bg-transparent md:border-0 md:hover:text-[#98C560] md:p-0 md:w-auto <?php echo e(request()->routeIs(['about', 'historia', 'biblioteca']) ? 'text-white bg-[#98C560] md:bg-transparent md:text-[#98C560]' : 'text-white bg-transparent'); ?>"
                            ...
                            <ul class="py-2 text-sm" aria-labelledby="dropdownLargeButton">
                                <li>
                                    <a href="<?php echo e(route('about')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('about') ? 'text-[#98C560]' : 'text-black'); ?>">
                                        Acerca
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('historia')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('historia') ? 'text-[#98C560]' : 'text-black'); ?>">
                                        Historia
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('biblioteca.papers.index')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('biblioteca') ? 'text-[#98C560]' : 'text-black'); ?>">
                                        Biblioteca
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li class="relative">
                        <button id="dropdownNavbarLink2"
                            class="flex items-center justify-between w-full py-2 px-3 text-white hover:bg-[#98C560] rounded-md md:hover:bg-transparent md:border-0 md:hover:text-[#98C560] md:p-0 md:w-auto <?php echo e(request()->routeIs(['direccion', 'capital']) ? 'text-white bg-[#98C560] md:bg-transparent md:text-[#98C560]' : 'text-white bg-transparent'); ?>"
                        ...
                        <div id="dropdownNavbar2" x-show="openDropdown === 'dropdownNavbar2'"
                            ...
                            <ul class="py-2 text-sm">
                                <li>
                                    <a href="<?php echo e(route('direccion')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('direccion') ? 'text-[#98C560]' : 'text-black'); ?>">
                                        Dirección
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('capital_usuario')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('capital_usuario') ? 'text-[#98C560]' : 'text-black'); ?>">
                                        Capital Humano
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('areas')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('areas') ? 'text-[#98C560]' : 'text-black'); ?>">
                    ...
                    <li class="relative">
                        <button id="dropdownNavbarLink3"
                            class="flex items-center justify-between w-full py-2 px-3 text-white hover:bg-[#98C560] rounded-md md:hover:bg-transparent md:border-0 md:hover:text-[#98C560] md:p-0 md:w-auto <?php echo e(request()->routeIs(['noticias', 'proyectos', 'eventos']) ? 'text-white bg-[#98C560] md:bg-transparent md:text-[#98C560]' : 'text-white bg-transparent'); ?>"
                            ...
                            <ul class="py-2 text-sm">
                                <li>
                                    <a href="<?php echo e(route('noticias')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('noticias') ? 'text-[#98C560]' : 'text-black'); ?>">
                                        Noticias
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('proyectos')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('proyectos') ? 'text-[#98C560]' : 'text-black'); ?>">
                                        Proyectos
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('eventos')); ?>"
                                        class="block px-4 py-2 hover:text-[#98C560] <?php echo e(request()->routeIs('eventos') ? 'text-[#98C560]' : 'text-black'); ?>">
                                        Eventos
                                    </a>
                                </li>
                            </ul>
...
<?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/usuario/layout/plantilla.blade.php ENDPATH**/ ?>