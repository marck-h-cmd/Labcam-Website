<?php $__env->startSection('title', 'crear paper'); ?>
...
<?php $__env->startSection('contenido'); ?>
    <div class="paper-container">
        ...
        <form class="p-10" action="<?php echo e(route('papers.store')); ?>" method="post" id="form" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                                ...
                                <?php if(!$topicos->isEmpty()): ?>
                                    <?php $__currentLoopData = $topicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="flex items-center space-x-2 p-2 hover:bg-gray-100 rounded-md">
                                            <input type="checkbox" value="<?php echo e($topico->id); ?>" class="checkbox-topico">
                                            <span><?php echo e($topico->nombre); ?></span>
                                        </label>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <label class="flex items-center space-x-2 p-2 hover:bg-gray-100 rounded-md">
...
<?php echo $__env->make('administrador.dashboard.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/administrador/panel/paper/create.blade.php ENDPATH**/ ?>