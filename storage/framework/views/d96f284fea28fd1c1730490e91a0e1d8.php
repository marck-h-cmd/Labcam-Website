...
<div class="Nosotros w-full px-5 mt-36">
  ...
  <div class="container flex justify-center items-center flex-wrap gap-5 mb-5 mx-auto">
    ...
    <div class="card flex flex-col w-4/5 max-w-96 bg-white shadow-lg rounded-lg">
      ...
      <a href="<?php echo e(route('biblioteca.paper')); ?>" class="detalles text-lg text-white italic font-bold bg-[#98c560] p-4 text-center rounded-b-lg hover:bg-[#66b308] transition-all duration-400 cursor-pointer">
        Más detalles ->
      </a>
    </div>
...
<?php echo $__env->make('usuario.layout.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRAS\PAGINA LABCAM\PROYECTO COMPARTIDO\Labcam-Website\resources\views/usuario/nosotros/biblioteca.blade.php ENDPATH**/ ?>