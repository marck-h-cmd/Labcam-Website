<?php $__env->startSection('title', 'Slider panel'); ?>
                                ...
                                <div class="flow-root">
                                    <div class="mt-10 overflow-x-auto">
                                        <div class="inline-block min-w-full py-2 align-middle">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="bg-white border-b  hover:bg-gray-50 ">
                                                            ...
                                                            <td class="p-4">
                                                                <img src="<?php echo e(Storage::url('uploads/imgs/' . $slider->historia_img)); ?>"
                                                                    class="w-16 md:w-32 max-w-full max-h-full"
                                                                    alt="Imagen <?php echo e($slider->id); ?>">
                                                            </td>
                                                            <td class="px-6 py-4 text-gray-900">
                                                                <?php echo $slider->descripcion; ?></p>
                                                            </td>
                                                            <td
                                                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                                <form class="flex" action="<?php echo e(route('h-slider.destroy', $slider->id)); ?>"
                                                                    method="POST">
                                                                    
                                                                    <a href="<?php echo e(route('h-slider.edit', $slider->id)); ?>"
                                                                    ...
                                                                    <a href="<?php echo e(route('h-slider.destroy', $slider->id)); ?>"
                                            ...
                                            <div class="mt-4 px-4">
                                                <?php echo $sliders->withQueryString()->links(); ?>
...
<?php echo $__env->make('administrador.dashboard.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/administrador/panel/h-slider-panel.blade.php ENDPATH**/ ?>