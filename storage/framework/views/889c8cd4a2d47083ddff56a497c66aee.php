<?php $__env->startSection('contenido'); ?>
    ...
    <form action="<?php echo e(route('admin-homeSliderUpdate')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?> <!-- Para hacer un update en lugar de un POST -->
        ...
        <div class="grid grid-cols-2 gap-8 items-center justify-center py-7">
            ...
            <div class="col-span-2 flex justify-center pt-2">
                <div class="flex flex-col items-center">
                    ...
                    <div class="relative">
                        <img id="image3-preview" src="/user/template/images/carrusel/<?php echo e($sliderAdmin->img3); ?>"
...
<?php echo $__env->make('administrador.dashboard.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRAS\PAGINA LABCAM\PROYECTO COMPARTIDO\Labcam-Website\resources\views/administrador/homeSlider.blade.php ENDPATH**/ ?>