    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center mb-8">
            ...
            <div class="flex-shrink-0 w-3/3">
                <img src="<?php echo e(asset('storage/' . $noticia->imagen)); ?>" alt="Imagen de la noticia" class="w-full rounded-lg shadow-md">
            </div>
...
<?php echo $__env->make('usuario.layout.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/usuario/Investigacion/detalle-noticias.blade.php ENDPATH**/ ?>