<?php $__env->startSection('title', 'Vista Noticias'); ?>
...
<?php $__env->startSection('contenido'); ?>
    <div class="max-w-screen-2xl mx-auto my-8 px-4">
                ...
                <tbody>
                    <?php $__currentLoopData = $noticias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noticia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b hover:bg-gray-50">
                            <td class="px-4 py-3"><?php echo e($noticia->titulo); ?></td>
                            <td class="px-4 py-3"><?php echo e($noticia->subtitulo); ?></td>
                            <td class="px-4 py-3"><?php echo e(Str::limit($noticia->contenido, 50)); ?></td>
                            <td class="px-4 py-3"><?php echo e($noticia->autor); ?></td>
                            <td class="px-4 py-3"><?php echo e($noticia->fecha); ?></td>
                            <td class="px-4 py-3 flex space-x-4">
                                <!-- Editar -->
                                <a href="<?php echo e(route('noticias.edit', $noticia->id)); ?>"
                                ...
                                <button onclick="openDeleteModal(<?php echo e($noticia->id); ?>, '<?php echo e($noticia->titulo); ?>')"
        ...
        <div class="flex justify-end text-sm mt-4">
            <?php echo e($noticias->links('pagination::tailwind')); ?>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 w-full h-full">
        <div class="flex items-center justify-center w-full h-full">
            <div class="bg-white p-7 rounded shadow-lg max-w-md w-full relative">
                ...
                <form id="deleteForm" method="POST" action="<?php echo e(route('noticias.destroy', '')); ?>" class="mt-4">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function openDeleteModal(id, titulo) {
            ...
            form.action = "<?php echo e(route('noticias.destroy', '')); ?>/" + id;
        }
...
<?php echo $__env->make('administrador.dashboard.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/administrador/panel/novedades/noticia/show.blade.php ENDPATH**/ ?>