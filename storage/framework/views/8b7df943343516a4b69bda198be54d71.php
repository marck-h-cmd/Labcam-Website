<?php $__env->startSection('contenido'); ?>
    ...
    <section class="pt-16 pb-2">
                ...
                <div class="animate_top sg vk rm xm">
                    <div class="c rc i z-1 pg">
                        ...
                        <div class="im h r s df vd yc wg tc wf xf al hh/20 nl il z-10">
                            <a href="<?php echo e(route('detalle-noticias')); ?>"class="vc ek rg lk gh sl ml il gi hi">Leer más</a>
                        </div>
                    </div>
        ...
        <div class="my-10 flex justify-center">
            <a href="<?php echo e(route('noticias')); ?>" class="bg-[#98C560] p-4 rounded-xl text-white cursor-pointer">
            VER MÁS NOTICIAS
            </a>
        </div>
    ...
    <section class="py-16">
            ...
            <div class="wc qf pn xo zf iq">
                ...
                <div class="animate_top sg vk rm xm">
                    <div class="c rc i z-1 pg">
                        ...
                        <div class="im h r s df vd yc wg tc wf xf al hh/20 nl il z-10">
                            <a href="<?php echo e(route('detalle-eventos')); ?>" class="vc ek rg lk gh sl ml il gi hi">Más detalles</a>
                        </div>
                    </div>
        ...
        <div class="my-10 flex justify-center">
            <a href="<?php echo e(route('eventos')); ?>" class="bg-[#98C560] p-4 rounded-xl text-white cursor-pointer">
            VER MÁS EVENTOS
           </a>
        </div>
...
<?php echo $__env->make('usuario.layout.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRAS\PAGINA LABCAM\PROYECTO COMPARTIDO\Labcam-Website\resources\views/usuario/index.blade.php ENDPATH**/ ?>