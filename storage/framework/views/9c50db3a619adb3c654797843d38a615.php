<?php $__env->startSection('contenido'); ?>
    <section class="py-12">
        ...
        <div class="flex items-center justify-center">
            ...
            <a href="<?php echo e(route('eventos', ['month' => $month == 1 ? 12 : $month - 1, 'year' => $month == 1 ? $year - 1 : $year])); ?>"
            ...
            <span class="text-lg font-semibold text-gray-700 uppercase">
                <?php echo e(\Carbon\Carbon::createFromDate($year, $month, 1)->locale('es')->translatedFormat('F, Y')); ?>

            </span>

            <!-- Botón de mes siguiente -->
            <a href="<?php echo e(route('eventos', ['month' => $month == 12 ? 1 : $month + 1, 'year' => $month == 12 ? $year + 1 : $year])); ?>"
        ...
        <div class="flex justify-center mt-4 mb-14 space-x-4">
            ...
            <a href="<?php echo e(route('eventos', ['category' => 'todo', 'month' => $month, 'year' => $year])); ?>"
            ...
            <a href="<?php echo e(route('eventos', ['category' => 'pasado', 'month' => $month, 'year' => $year])); ?>"
            ...
            <a href="<?php echo e(route('eventos', ['category' => 'futuro', 'month' => $month, 'year' => $year])); ?>"
            ...
            <?php $__currentLoopData = $eventos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div
                    ...
                    <a href="#" class="w-full h-full block">
                        <img src="<?php echo e(Storage::url($evento->imagen)); ?>" alt="<?php echo e($evento->titulo); ?>"
...
<?php echo $__env->make('usuario.layout.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/usuario/novedades/eventos.blade.php ENDPATH**/ ?>