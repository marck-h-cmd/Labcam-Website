...
<div class="container mx-auto py-1 mt-1">
    <div class="grid grid-cols-2 gap-6">
        <!-- Formulario -->
        <div>
            <form action="<?php echo e(route('contacto')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('usuario.layout.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRAS\PAGINA LABCAM\PROYECTO COMPARTIDO\Labcam-Website\resources\views/usuario/contacto.blade.php ENDPATH**/ ?>