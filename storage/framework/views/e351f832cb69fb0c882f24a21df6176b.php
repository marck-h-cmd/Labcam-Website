    ...
    <div class="p-2">
        <div class="max-w-[1200px] mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="w-full">
                    <form class="sm:flex sm:items-center sm:justify-between flex-col sm:flex-row gap-4" action="<?php echo e(route('capitales.store')); ?>" method="POST" id="form">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
                                    ...
                                    <tbody id="table-body" class="divide-y divide-gray-200 bg-white">
                                        <?php $__currentLoopData = $capitales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $capital): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr data-role="<?php echo e($capital->rol); ?>" class="even:bg-gray-50">
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    <?php echo e($capital->nombre); ?>

                                                </td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    <?php echo e($capital->carrera); ?>

                                                </td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    <?php echo e($capital->areaInvestigacion->nombre); ?>

                                                </td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    <?php echo e($capital->correo); ?>

                                                </td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    <?php echo e($capital->cv); ?>

                                                </td>
                                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                    <form action="<?php echo e(route('capitales.destroy', $capital->id)); ?>" method="POST">
                                                        <a href="<?php echo e(route('capitales.edit', $capital->id)); ?>" class="text-indigo-600 font-bold hover:text-indigo-900  mr-2">
                                                            Editar
                                                        </a>
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <a href="<?php echo e(route('capitales.destroy', $capital->id)); ?>"
                                ...
                                <div class="mt-4 px-4">
                                    <?php echo $capitales->withQueryString()->links(); ?>
    ...
    <div id="createModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 w-full h-full">
        <div class="flex items-center justify-center w-full h-full">
            <div class="bg-slate-200 p-7 rounded shadow-lg max-w-4xl w-full relative">
                ...
                <!-- Contenido del modal -->
                <form id="form" action="<?php echo e(route('capitales.store')); ?>" method="POST" enctype="multipart/form-data" class="flex gap-6">
                    ...
                    <div class="w-2/3">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="area_investigacion" name="area_investigacion" class="w-full px-4 py-2 border rounded" required>
                                ...
                                <?php $__currentLoopData = $areasInvestigacion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('administrador.dashboard.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/administrador/organizacion/capital_humano/index_capital.blade.php ENDPATH**/ ?>