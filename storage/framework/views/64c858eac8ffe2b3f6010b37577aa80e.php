...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#1E5397] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            <li
                class="mb-1 group <?php echo e(request()->routeIs(['admin-homeSlider', 'admin-homeProyectos']) ? 'active' : ''); ?>">
                <a
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                        <a href="<?php echo e(route('admin-homeSlider')); ?>"
                            ...
                            <span
                                class="w-2.5 h-2.5 rounded-full mr-3 <?php echo e(request()->routeIs('admin-homeSlider') ? 'bg-[#98C560]' : 'bg-transparent'); ?>"></span>
                            Slider
                        </a>
                    </li>
                    <li class="mb-4">
                        <a href="<?php echo e(route('admin-homeProyectos')); ?>"
                            class="text-sm flex items-center py-2 px-4 rounded-md text-white">
                            <span
                                class="w-2.5 h-2.5 rounded-full mr-3 <?php echo e(request()->routeIs('admin-homeProyectos') ? 'bg-[#98C560]' : 'bg-transparent'); ?>"></span>
                            Top Proyectos
                        </a>
                    </li>
                </ul>
...
<?php /**PATH D:\CURSOS EXTRAS\PAGINA LABCAM\PROYECTO COMPARTIDO\Labcam-Website\resources\views/administrador/dashboard/plantilla.blade.php ENDPATH**/ ?>