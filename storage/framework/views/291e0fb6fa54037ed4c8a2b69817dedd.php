<?php $__env->startSection('title', 'Crear Slider historia'); ?>
...
<?php $__env->startSection('contenido'); ?>
    <div class="slider-container ">
        ...
        <form class="md:px-20 px-40 py-10 " action="<?php echo e(route('h-slider.store')); ?>" method="post" id="form"
...
<?php echo $__env->make('administrador.dashboard.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/administrador/panel/historia-slider/create-slider.blade.php ENDPATH**/ ?>