                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        ...
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="<?php echo e(route('papers.create')); ?>"
                    ...
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
                            <div class="inline-block min-w-full py-2 align-middle">
                                        ...
                                        <?php $__currentLoopData = $papers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paper): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="even:bg-gray-50">
                                                ...
                                                <td class="whitespace-nowrap px-3 py-8 text-sm text-gray-600">
                                                    <?php echo e($paper->titulo); ?></td>
                                                <td class="whitespace-nowrap px-3 py-8 text-sm text-gray-500">
                                                    <?php echo e($paper->area->nombre); ?></td>
                                                <td
                                                    class="whitespace-nowrap px-3 py-8 text-sm text-gray-600 overflow-hidden max-w-96">
                                                    <?php echo e($paper->descripcion); ?></td>
                                                <td class="whitespace-nowrap px-3 py-8 text-sm text-gray-500">
                                                    <?php echo e($paper->formatted_autores); ?></td>
                                                <td class="whitespace-nowrap px-3 py-8 text-sm text-gray-500">
                                                    <?php echo e($paper->publisher); ?></td>
                                                <td class="whitespace-nowrap px-3 py-8 text-sm text-gray-500">
                                                    <?php echo e($paper->doi); ?></td>
                                                <td class="whitespace-nowrap px-3 py-8 text-sm text-gray-500">
                                                    <?php echo e($paper->fecha_publicacion); ?></td>
                                                <td class="whitespace-nowrap px-3 py-8 text-sm text-gray-500 ">
                                                    <button type="button"  onclick="openModal('<?php echo e(Storage::url('uploads/paper_img/' . $paper->img_filename)); ?>')" 
                                                ...
                                                <td class="whitespace-nowrap px-3 py-8 text-sm text-gray-500">
                                                    <a href="/storage/uploads/pdf/<?php echo e($paper->pdf_filename); ?>"
                                                ...
                                                <td
                                                    ...
                                                    <form  class="flex" action="<?php echo e(route('papers.destroy', $paper->id)); ?>"
                                                        method="POST">
                                                        <a href="<?php echo e(route('biblioteca.papers.show', $paper->id)); ?>"
                                                        ...
                                                        <a href="<?php echo e(route('papers.edit', $paper->id)); ?>"
                                                        ...
                                                        <a href="<?php echo e(route('papers.destroy', $paper->id)); ?>"
                                ...
                                <div class="mt-4 px-4">
                                    <?php echo $papers->withQueryString()->links(); ?>
...
<?php echo $__env->make('administrador.dashboard.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/administrador/panel/paper-panel.blade.php ENDPATH**/ ?>