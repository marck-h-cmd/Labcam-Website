...
<div class="bg-white p-8 rounded-lg shadow-lg w-96 relative">
    <div class="absolute -top-16 left-1/2 transform -translate-x-1/2">
        <img src="<?php echo e(asset('images/login.png')); ?>" alt="Ilustración" class="rounded-full h-32 w-32 border-4 border-white shadow-lg">
    </div>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
            <input type="email" name="email" placeholder="Correo electrónico" value="<?php echo e(old('email')); ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div class="mb-4">
        ...
        <p class="text-center text-sm">¿No tienes una cuenta? <a href="<?php echo e(route('register-user')); ?>" class="text-blue-500 hover:underline">Registrarme</a></p>
    </form>
</div>
</body>
</html>
<?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/usuario/auth/login.blade.php ENDPATH**/ ?>