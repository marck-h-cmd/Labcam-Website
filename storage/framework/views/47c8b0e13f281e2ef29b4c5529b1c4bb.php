...
<?php $__env->startSection('contenido'); ?>
                                            ...
                                            <div class="p-4 pb-0 text-gray-900 md:pb-4">
                                                <ul class="space-y-4">
                                                    <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                                            <a href="<?php echo e(route('biblioteca.area', $area->id)); ?>"
        ...
        <div class="Nosotros max-w-screen-2xl max w-full px-5 mx-auto mt-36">
            ...
            <div class="grid  grid-cols-10 gap-x-16 max-lg:grid-cols-1 justify-center">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li>
                                ...
                                <ul id="dropdown-example-2" class=" py-2 space-y-2 overflow-y-auto max-h-52">
                                    <?php $__empty_1 = true; $__currentLoopData = $topicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li>
                                            ...
                                            <span
                                                ...
                                                <input class="mr-2" type="checkbox" value="<?php echo e($topico->id); ?>"
                                                    class="checkbox-topico">
                                                <?php echo e($topico->nombre); ?> <span
                                                    class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-600 bg-blue-200 rounded-full"><?php echo e(count($topico->papers)); ?></span></span>
                                        </li>
                            ...
                            <li>
                                ...
                                <ul id="dropdown-example" class=" py-2 space-y-2 overflow-y-auto max-h-36">
                                    <?php $__empty_1 = true; $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li>
                                            <a href="<?php echo e(route('biblioteca.area', $area->id)); ?>"
                                                class="flex items-center w-full p-2 text-base font-normal text-gray-600 transition duration-75 rounded-lg group hover:bg-gray-100  "><?php echo e($area->nombre); ?></a>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <li>
                                            <a href="#"
                ...
                <div class="pt-6 pb-12  col-span-7">
                            ...
                            <div id="papers-container"class="container w-100 lg:w-4/5  mx-auto flex flex-col">
                                ...
                                <div class="px-4 ">
                                    <div
                                        ...
                                        <p class="text-gray-50 ">Mostrando <?php echo e(count($papers)); ?> resultados</p>
                                        <button id="menuBtn"
                    ...
                    <?php if(count($papers) > 3 && count($papers) != 3): ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            let offset = <?php echo e($papers->count()); ?>;
            //  console.log(offset)
            const limit = 3;
...
<?php echo $__env->make('usuario.layout.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/usuario/nosotros/biblioteca.blade.php ENDPATH**/ ?>