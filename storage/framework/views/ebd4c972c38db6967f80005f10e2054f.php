<?php $__env->startSection('title', 'topico'); ?>
                    ...
                    <div class="max-w-[1200px] mx-auto sm:px-6 lg:px-8 space-y-6">
                        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            <div class="w-full">
                                ...
                                <form class="sm:flex sm:items-center" action="<?php echo e(route('topics.store')); ?>" method="post"
                                    id="form">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="inline-block min-w-full py-2 align-middle">
                                            <table class="w-full divide-y divide-gray-300">
                                                ...
                                                <tbody class="divide-y divide-gray-200 bg-white">
                                                    <?php $__currentLoopData = $topicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="even:bg-gray-50">
                                                            ...
                                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                                <?php echo e($topico->id); ?></td>
                                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                                <?php echo e($topico->nombre); ?></td>

                                                            <td
                                                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                                <form action="<?php echo e(route('topics.destroy', $topico->id)); ?>"
                                                                    method="POST">
                                                                    <a href="<?php echo e(route('topics.edit', $topico->id)); ?>"
                                                                        class="text-indigo-600 font-bold hover:text-indigo-900  mr-2">Editar</a>
                                                                    <?php echo csrf_field(); ?>
                                                                    <?php echo method_field('DELETE'); ?>
                                                                    <a href="<?php echo e(route('topics.destroy', $topico->id)); ?>"
                                            ...
                                            <div class="mt-4 px-4">
                                                <?php echo $topicos->withQueryString()->links(); ?>
...
<?php echo $__env->make('administrador.dashboard.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CURSOS EXTRA ACADEMICOS\PAGINA LABCAM\PROYECTO\Labcam-Website\resources\views/administrador/panel/categoria-investigacion/topico-panel-tab.blade.php ENDPATH**/ ?>